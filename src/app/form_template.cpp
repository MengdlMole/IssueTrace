...
FormTemplateDefinition parseFormTemplate(const QByteArray& json) {
    ...
    const QHash<QString, QString> expectedFields{
        ...
        {QStringLiteral("reporter"), QStringLiteral("history_select")},
        {QStringLiteral("reported_at"), QStringLiteral("datetime")},
        {QStringLiteral("assignee"), QStringLiteral("history_select")},
        ...
        {QStringLiteral("group_name"), QStringLiteral("history_select")},
